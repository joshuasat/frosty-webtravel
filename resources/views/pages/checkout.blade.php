        ...
        <div class="row">
          <div class="col-lg-8 pl-lg-0">
            <div class="card card-details mb-3">
              ...
              <h1>Who is Going?</h1>
              <p>
                Trip to {{$item->travel_packet->title}}, {{$item->travel_packet->location}}
              </p>
              <div class="attendee">
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <table class="trip-informations">
                ...
                <tr>
                  ...
                  <td width="50%" class="text-right">$ {{ $item->travel_packet->price }},00/person</td>
                </tr>
                <tr>
              ...
              <div class="bank">
                <div class="bank-item pb-3">
                  <img src="{{url('frontend/images/icon_bank.png')}}" alt="" class="bank-image" />
            ...
            <div class="text-center mt-3">
              <a href="{{route('detail', $item->travel_packet->slug)}}" class="text-muted">Cancel Booking</a>
            </div>
          </div>
        </div>
      </div>
...
<script>
  $(document).ready(function () {
    $('.datepicker').datepicker({
      ...
      icons: {
        rightIcon: '<img src="{{url('frontend/images/icon_doe.png')}}" alt="" />'
      }
    });
  });
</script>
